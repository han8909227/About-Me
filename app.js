...
// var oneCorrect = ['YES','Y']
//
// var oneAsk = prompt(console.log(oneQue)).toUpperCase;
// for(i=0, i<oneAns.length; i++){
//   if(oneAsk = oneCorrect[i])
...
while(userSport.length < 6 && exitSport){
  ...
  if(predictSport === mySport[0] || predictSport === mySport[1]){
    alert("That is correct! " + predictSport + " is one of my favorite sport");
    exitSport = false;
    totalRight += 1;
